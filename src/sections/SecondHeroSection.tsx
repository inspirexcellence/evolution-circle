...
export const SecondHeroSection: React.FC = () => {
  ...
  return (
    <section className="relative w-full min-h-[520px] lg:min-h-[600px] xl:min-h-[680px] flex justify-center overflow-hidden"
      style={{ backgroundColor: "#EDE7DB" }}
    >
      <div className="relative w-full max-w-[1400px] mx-auto flex flex-col lg:flex-row min-h-full">
        {/* ═══════════════════════════════════════════════════════════ */}
        {/* LEFT TEXT SIDE (~50%) */}
        {/* ═══════════════════════════════════════════════════════════ */}
        <motion.div
        ...
        >
          ...
          <div className="relative overflow-hidden mb-5 inline-flex items-center gap-2 bg-[#8A6B32]/10 border border-[#8A6B32]/20 px-4 py-2 rounded-full self-start">
            ...
            <span className="text-[12px] font-bold text-[#1A3B2F] uppercase tracking-widest relative z-10">October 02, 2026</span>
          </div>

          {/* Audience line */}
          <p
            className="text-[15px] sm:text-[16px] lg:text-[18px] font-normal leading-relaxed mb-5 max-w-[500px] lg:max-w-[550px]"
          ...
          <div className="space-y-3 max-w-[500px] lg:max-w-[550px]">
            <p
        ...
        <motion.div
          ...
          className="relative lg:absolute lg:right-0 lg:inset-y-0 z-0 w-full lg:w-[60%] xl:w-[55%] min-h-[420px] sm:min-h-[500px] lg:min-h-full pl-6 sm:pl-10 lg:pl-0 pr-6 sm:pr-10 lg:pr-16 pb-10 lg:pb-0"
        >
          <div className="relative w-full h-full min-h-[380px] sm:min-h-[450px] lg:min-h-full rounded-3xl lg:rounded-l-none lg:rounded-r-3xl overflow-hidden lg:overflow-visible">
            <Image
              ...
              className="object-cover object-center rounded-3xl lg:rounded-l-none lg:rounded-r-3xl"
            />

            {/* Desktop left-edge gradient (hidden on mobile) */}
            <div
              className="hidden lg:block absolute inset-y-0 -left-[2px] w-[150px] lg:w-[250px] pointer-events-none z-[1]"
              style={{
